...
@Component({
  selector: 'app-division5',
  templateUrl: './division5.component.html'
})
export class Division5Component implements OnInit {
  matches: PadelMatch[] | undefined;
  top10: Player[] | undefined;
  num = 5;
  logged = false;

  constructor(public service: MatchesService, private loginService: LoginService) {
   }
  ngOnInit(): void {
